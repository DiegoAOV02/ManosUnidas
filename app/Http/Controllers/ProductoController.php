    ...
    public function store(Request $request)
{
    $request->validate([
        ...
        'descripcionProducto' => 'nullable|string|max:1000',
        'precioProducto' => 'required|numeric|min:0.01',
        'unidadesDisponibles' => 'required|integer|min:1',
        'categoria' => 'required|string|in:Belleza y Cuidado Personal,Construcción,Electrodomésticos,Hogar y Muebles,Moda,Supermercado,Tecnología,Vehículos',
        'imageUpload' => 'required|image|mimes:jpeg,jpg,png|max:2048',
    ]);
    ...
    return redirect()->route('vender')->with('success', '¡El producto se publicó con éxito!');
}
