                    ...
                    <ul class="p-2 space-y-2 text-sm">
                        <li class="hover:bg-blue-100 px-2 py-1 rounded">
                            <a href="{{ route('categorias', ['categoria' => 'Belleza y Cuidado Personal']) }}" 
                               onclick="updateTitle('Belleza y Cuidado Personal')" 
                               class="block">Belleza y Cuidado Personal</a>
                        </li>
                        <li class="hover:bg-blue-100 px-2 py-1 rounded">
                            <a href="{{ route('categorias', ['categoria' => 'Construcción']) }}" 
                               onclick="updateTitle('Construcción')" 
                               class="block">Construcción</a>
                        </li>
                        <li class="hover:bg-blue-100 px-2 py-1 rounded">
                            <a href="{{ route('categorias', ['categoria' => 'Electrodomésticos']) }}" 
                               onclick="updateTitle('Electrodomésticos')" 
                               class="block">Electrodomésticos</a>
                        </li>
                        <li class="hover:bg-blue-100 px-2 py-1 rounded">
                            <a href="{{ route('categorias', ['categoria' => 'Hogar y Muebles']) }}" 
                               onclick="updateTitle('Hogar y Muebles')" 
                               class="block">Hogar y Muebles</a>
                        </li>
                        <li class="hover:bg-blue-100 px-2 py-1 rounded">
                            <a href="{{ route('categorias', ['categoria' => 'Moda']) }}" 
                               onclick="updateTitle('Moda')" 
                               class="block">Moda</a>
                        </li>
                        <li class="hover:bg-blue-100 px-2 py-1 rounded">
                            <a href="{{ route('categorias', ['categoria' => 'Supermercado']) }}" 
                               onclick="updateTitle('Supermercado')" 
                               class="block">Supermercado</a>
                        </li>
                        <li class="hover:bg-blue-100 px-2 py-1 rounded">
                            <a href="{{ route('categorias', ['categoria' => 'Tecnología']) }}" 
                               onclick="updateTitle('Tecnología')" 
                               class="block">Tecnología</a>
                        </li>
                        <li class="hover:bg-blue-100 px-2 py-1 rounded">
                            <a href="{{ route('categorias', ['categoria' => 'Vehículos']) }}" 
                               onclick="updateTitle('Vehículos')" 
                               class="block">Vehículos</a>
                        </li>
                    </ul>
                </div>
            </div>
        ...
        <div class="relative z-50">
            ...
            <div id="profile-dropdown"
                ...
                <ul class="p-2 space-y-2 text-sm">
                    ...
                    <li class="hover:bg-blue-100 px-2 py-1 rounded"><a href="/compras" class="block text-gray-800">Mis
                            compras</a></li>
